package soonmap.security.oauth;
...
import soonmap.security.oauth.OAuthApi.KakaoOAuthApi;
...
public class KakaoLoginBO {
    ...
    public SocialUserInfoDto getKakaoUserInfo(OAuth2AccessToken accessToken) throws IOException {
        // OAuth20Service 생성
        OAuth20Service oAuth20Service = new ServiceBuilder()
                .apiKey(CLIENT_ID)
                .apiSecret(CLIENT_SECRET)
        ...
        return new SocialUserInfoDto(id.toString(), nickname, email);
    }
}